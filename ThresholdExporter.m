...
%% Vulture
% Vulture Root
VultureRoot = '\\CIDCSDFS01\EBU_Data01$\NACTGx\common\DL_Diag\Data Analysis\Storage\MinMax Parameter Lists\Vulture';
% Vulture Default (use the FE family as default)
exportThresholds(r,l,fullfile(VultureRoot,'Downloads from CalbertNG\Vulture_FE'),'Vulture','Default','BHQ')
%Vulture_FE
exportThresholds(r,l,fullfile(VultureRoot,'Downloads from CalbertNG\Vulture_FE'),'Vulture','Vulture_FE','BHQ')
%Vulture_HO
exportThresholds(r,l,fullfile(VultureRoot,'Downloads from CalbertNG\Vulture_HO'),'Vulture','Vulture_HO','BHQ')

%% Thunderbolt
% Thunderbolt Root
ThunderboltRoot = '\\CIDCSDFS01\EBU_Data01$\NACTGx\common\DL_Diag\Data Analysis\Storage\MinMax Parameter Lists\Thunderbolt';
% Thunderbolt Default (use the CC_Auto family as default)
exportThresholds(r,l,fullfile(ThunderboltRoot,'Downloads from CalbertNG\CC_Auto'),'Thunderbolt','Default','BHQ')
% Thunderbolt CC_Auto
exportThresholds(r,l,fullfile(ThunderboltRoot,'Downloads from CalbertNG\CC_Auto'),'Thunderbolt','Thunderbolt_CC_Auto','BHQ')
...
nighthawkRoot = '\\CIDCSDFS01\EBU_Data01$\NACTGx\common\DL_Diag\Data Analysis\Storage\MinMax Parameter Lists\Nighthawk';
% Nighthawk Default (use In Progress)

exportThresholds(r,l,fullfile(nighthawkRoot,'Downloads from CalbertNG'),'Nighthawk','Default','BGU')
