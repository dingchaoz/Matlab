...
SET SERVERNAME=tcp:W3-A11259\CAPABILITYDB
...
SET NETWORKSAVDIR=N:\DL_Diag\2013 OBD Capability Analysis\Pacific\RawData\dat\
:: Define the network directory where to copy the local file to for safe keeping [NEED TRAILING \]
...
SET PROGRAMS=Atlantic HDPacific Pele Mamba DragonCC DragonMR Seahawk Yukon Blazer Bronco Clydesdale Shadowfax Vanguard Ventura PacificArchive PacificArchive2
