...
%   Revised - Dingchao Zhang - 2016/2/25
%     - Modified the SQL statements to union AcadiaArchive and AcadiaArchive2 DBs 
    ...
    if length(varargin) == 6
        ...
        if rprt == 1
            ...
            if ~strcmp(obj.program,'Acadia')
                ...
                % Define the generic sql code for event driven data grouped
                % by truck and sw which unions AcadiaArchive and
                % AcadiaArchive2 DBs
                    sql =  [declare,' SELECT * FROM ('...
                        ' SELECT [tblTemp].[CalibrationVersion]',...
                        '      ,[TruckName],[Family],[TruckType]',...
                        ...
                        '  WHERE [SEID] = @seid And [ExtID] = @extid And [EMBFlag] = 0 And [TripFlag] = 0',...
                        '  GROUP BY [TruckID],[CalibrationVersion]',...
                        '  UNION ALL SELECT [CalibrationVersion]',...
                        '      ,[TruckID]',...
                        '      ,MIN([DataValue]) As MinimumData',...
                        '      ,MAX([DataValue]) As MaximumData',...
                        '      ,AVG([DataValue]) As Mu',...
                        ...
                        '      ,MIN([datenum]) As StartDate',...
                        '      ,MAX([datenum]) As EndDate',...
                        '  FROM [AcadiaArchive].[dbo].[tblEventDrivenData]',...
                        '  WHERE [SEID] = @seid And [ExtID] = @extid And [EMBFlag] = 0 And [TripFlag] = 0',...
                        '  GROUP BY [TruckID],[CalibrationVersion]',...
                        '  UNION ALL SELECT [CalibrationVersion]',...
                        '      ,[TruckID]',...
                        ...
                        '      ,MIN([datenum]) As StartDate',...
                        '      ,MAX([datenum]) As EndDate',...
                        '  FROM [AcadiaArchive2].[dbo].[tblEventDrivenData]',...
                        '  WHERE [SEID] = @seid And [ExtID] = @extid And [EMBFlag] = 0 And [TripFlag] = 0',...
                        '  GROUP BY [TruckID],[CalibrationVersion]',...
                        '  ) As tblTemp LEFT OUTER JOIN',...
                        '  (SELECT [CalibrationVersion]',...
        ...
        elseif rprt == 2
            if ~strcmp(obj.program,'Acadia')
                 ...
                 % Define the generic sql code for event driven data grouped by truck, time, sw
                 % for Acadia db which unions Acadia Archive and
                 % AcadiaArchive2 dbs
                    sql = [declare,' SELECT * FROM ('...
                           ' SELECT [tblTemp].[TimePeriod]',...
                           '      ,[tblTemp].[CalibrationVersion]',...
