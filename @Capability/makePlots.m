...
%   Revised - N/A - N/A
    ...
    for i = 1:length(obj.ppi.SEID) % Pacific test of all combinations [1 2 4 5 20 51 112 134]%
        ...
        % Skip the following diagnostics for certain programs
        if strcmp(sename,'CSERS_POS_RAIL_PRESS_DEV_ERROR') && (strcmp(obj.program,'Vanguard') || strcmp(obj.program,'Ventura'))  % huge values which cause Matlab to crash when saving plots
        else
