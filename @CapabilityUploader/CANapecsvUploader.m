function [filesP,timeP,filesE,timeE] = CANapecsvUploader(obj, rootDir, truckID)
%Upload directory of CANape .csv files for a specified truck id number
%   This uses CANape.csv files and assumes that the system time is in UTC which is how
...
%   Original Version - Dingchao Zhang - Dec 5, 2014
    ...
    for i = 1:length(fileList)
        ...
        try
            ...
            obj.CANapeAddCSVFile(fullFilePath, truckID);
