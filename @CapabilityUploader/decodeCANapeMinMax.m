function decodedData = decodeCANapeMinMax(obj, publicDataID, data, cal)
        ...
        if strcmp(ex.identifier, 'Capability:updateParamInfoCache:ParameterDoesNotExist')
            ...
            if obj.getNumDIBParameters(cal) > 0
                if strcmp(hexString, 'AAAAAAAA')
                    ...
                    error('CapabilityUploader:decodeMinMax:PossibleCorruptDataInBuild', ...
                        ...
                        'or the wrong calibration version was speficied.']);
                end
